...
export const Sidebar: React.FC<SidebarProps> = ({ isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <aside
        className={`fixed top-0 left-0 z-40 h-screen w-64 glass-sidebar transition-transform duration-300 ease-out flex flex-col justify-between shadow-2xl md:shadow-none ${
